    ...
    <div class="modal-information"  id="popupGameFailed"  style ="display:none">
        <div class="form-information-user" >
            ...
            <div class="position-close2">
                <svg viewBox="0 0 24 24"  onclick="CloseFormPopupGameFail()"  size="24" class="sc-11csm01-0 fivNSm">
                    <path
           ...
           <h6>Chúc Quý khách may mắn lần sau </h6>

           <p>NHƯNG  bạn vẫn được nhận  Ưu Đãi từ  </p>
           <p>Nhãn Hàng chính hãng tài trợ </p>
           <p>Xin vui lòng Đăng ký / Đăng nhập  </p>
           <p> để chúng tôi liên hệ  sớm</p>
