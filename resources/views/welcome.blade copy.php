...
<head>
    ...
    <meta name="google-signin-client_id" content="99889975606-e3s508a6nh0n7v6ctfev88id4h4ijk77.apps.googleusercontent.com">
    ...
    <meta name="google-signin-client_id" content="99889975606-8djbbqqbf47d16rdeu454l3cjabfa4lp.apps.googleusercontent.com">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body loginpopup">
                    ...
                    {{-- <button class="login-google" onclick="loginwithGoogle()">
                        ...
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="abcRioButtonSvg" style="
height: 18px;
...
"><g><path fill="#EA4335" d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l7.98 6.19C12.43 13.72 17.74 9.5 24 9.5z"></path><path fill="#4285F4" d="M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.18 7.09-10.36 7.09-17.65z"></path><path fill="#FBBC05" d="M10.53 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78l7.97-6.19z"></path><path fill="#34A853" d="M24 48c6.48 0 11.93-2.13 15.89-5.81l-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"></path><path fill="none" d="M0 0h48v48H0z"></path></g></svg>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body loginpopup">
                    ...
                    <p class="bottomPage">Bạn đã có tài khoản?
    ...
    <div id="b-placeholder">
        ...
        <div class="ai-skin__container">
            <img id ="displayLoading" class="loadingImage" src="/Ripple-1s-247px.svg" />
            <div class="ai-skin__skin">
                <div class="ai-skin__navigator">
                    <div class="ai-skin__navigator-inner">
                        <a onclick="backPre()">
                            <img data-src="contain/img/icons/back.svg" src="/img/icons/back.svg">
                        </a>
                        <span>SOI DA AI ONLINE</span>
                        <a onclick="openHomePage()">
                            <img data-src="contain/img/icons/home.svg" src="/img/icons/home.svg">
                        </a>
                    </div>
                </div>

                <div class="sctn-block h-20 a-cm sctn-action">
                    <div class="action-cta action-cta-take">

                        <input type="button" onclick="opencamera()" class="upload-file">
                        <div class="icn"><img src="./assets/photo-selfie.25ed5a17 (1).svg" alt="" class="selfie"></div>
                ...
                <div class="ai-skin__skin-top" style="display: none;">
                    ...
                    <button id="choseImageFile" type="button"
                        class="ai-skin__skin-option ai-skin__skin-top__choose-image" onclick="skinModule.chooseImage()">
                        <span>
                            Chọn ảnh
                ...
                <div class="ai-skin-skin-body">
                    <div class="ai-skin__skin-image ai-skin__skin-image--inactive" id="skinImage">
                        <img class="ai-skin__skin-image__background" data-src="contain/img/placeholders/skin1.png"
                            src="/img/placeholders/skin1.png">
                ...
                function saveHistory(result) {
                    ...
                    if (sessionStorage.getItem("dataCompany") === null) {
                        ...
                        if (company == null) {
                            ...
                            companyId = company.company_data._id;
                        }
                    ...
                    if (dataUser) {
                        ...
                        token = objectreponse.data.token;

                    }
                    
                    $.ajax({
                        type: "POST",
                        url: "https://api-soida.applamdep.com/api/add-history-skin-app",
                        data: JSON.stringify({
                            "Result": result,
   ...
   <script>
    ...
    getUserByGoogleId(profile.getId());
  ...
  function getUserByGoogleId (googleId) 
   {
        $.ajax({
        url: "https://api-soida.applamdep.com/api/get-enduser-by-googleid",
        type: "post",
        data: {
        "google_id":  googleId,
        ...
        if(response.is_success)
        {
            ...
            {
                // 
                var userItem = sessionStorage.getItem('dataUser');
                // userItem =  null;
                // 
   ...
   function loginGoogle (reponse )
{ 
  
    var dataUser = reponse[0];
    if(googleuserGlobal ==null)
    {
      
        return;
    }
    
    var profile = googleuserGlobal.getBasicProfile();
    $.ajax({
   ...
   function loginGoogleUser(datauserGoogle)
   {
     loginGoogle(datauserGoogle);
   ...
   function createUserGoogle () 
   {
    ...
    $.ajax({
        url: "https://api-soida.applamdep.com/api/add-end-user",
        type: "post",
        data: {
