...
<div class ="viewpdf">
    ...
    <div class="display-title">
     ...
     <!-- <embed src=" http://localhost:8002/Khong-Gi-Chet-Di-Bao-Gio - Viet-Thanh-Nguyen-1.pdf" width="600" height="500" alt="pdf" pluginspage="http://www.adobe.com/products/acrobat/readstep2.html"> -->
     <!-- <img src=" http://localhost:8002/Khong-Gi-Chet-Di-Bao-Gio - Viet-Thanh-Nguyen-1.pdf"> -->
     <!-- <iframe src="https://docs.google.com/viewer?url= http://localhost:8002/233.pdf&embedded=true" style="width:100%; height:100%;" frameborder="0"></iframe> -->

     <!-- <embed src=" http://localhost:8002/Khong-Gi-Chet-Di-Bao-Gio - Viet-Thanh-Nguyen-1.pdf" width="800" height="500" type='application/pdf'> -->
