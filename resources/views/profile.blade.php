        ...
        <script>
            var skinModule = (function () {
                ...
                function saveHistory(result) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "http://http://192.168.1.37:3002:3002/api/add-history-skin",
                        data: JSON.stringify({
                            "UserName": null,
                            "Result": result,
                            "User_Id": null,
                ...
                function drawProduction(dataRequest) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "http://http://192.168.1.37:3002:3002/itemSdk/get_product_result",
                ...
                <div class="slick-carousel mb-3">';
                        ...
                        for (let i = 0; i < listProduct.length; i++) {
                            ...
                            if (itemProduct.image_link.length > 0) {
                                imagelink = "http://http://192.168.1.37:3002:3002/public/image_plugin/" + itemProduct.image_link;
                            } else {
